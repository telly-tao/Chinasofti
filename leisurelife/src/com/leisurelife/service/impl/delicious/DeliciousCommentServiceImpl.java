...
import com.leisurelife.dao.delicious.DeliciousCommentDao;
import com.leisurelife.dao.impl.delicious.DeliciousCommentDaoImpl;
...
public class DeliciousCommentServiceImpl implements DeliciousCommentService {

	@Override
	public String deliciousCommentRequest(Map<String, Object> map) {
		//获取影评Dao对象
